...
namespace milkWebAPIs.api.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IMilkRepository repo, IMapper mapper, IOptions<CloudinarySettings> cloudinaryConfig) 
        {
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            if (!user.Photos.Any(p => p.Id == id)) // If the photo id we are passing in doesnot matches any photo IDs then return unathorized
            return Unauthorized();
